...
public class RestoreReadDbController {
    ...
    public ResponseEntity<BaseResponse> restoreReadDb() {
        try {
            ...
            return new ResponseEntity<>(new BaseResponse("Read database restore request executed successfully!"), HttpStatus.CREATED);
        }
            ...
            var safeErrorMessage = "Error, while processing the read database Restore request";
